                ...
                <ul className="flex flex-col w-full">
                    ...
                    <li className="my-px">
                        ...
                        >
                            ...
                            <span className="mr-3">Manager</span>
                        </a>
                    </li>
                    <li className="my-px">
                        <a
                        ...
                        >
                            ...
                            <span className="mr-3">Tasks</span>
                        </a>
                    </li>
                    <li className="my-px">
                        <a
                        ...
                        >
                            ...
                            <span className="mr-3">Clients</span>
                            <span
...
export default SidebarPanelLayoutTest;